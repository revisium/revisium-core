...
import { GetTablesByRevisionIdQuery } from 'src/revision/queries/impl/get-tables-by-revision-id.query';
import { GetRevisionTablesReturnType } from 'src/revision/queries/types';
