  ...
  describe('Read Operations', () => {
    ...
    describe('GET /revision/:revisionId/tables/:tableId/rows/:rowId', () => {
      ...
      it('should return 404 for non-existent row', async () => {
        ...
        return request(app.getHttpServer())
          .get(
            `/api/revision/${preparedData.project.draftRevisionId}/tables/${preparedData.project.tableId}/rows/${nonExistentRowId}`,
          )
          .set('Authorization', `Bearer ${preparedData.owner.token}`)
          .expect(404);
      });
    ...
    describe('GET /revision/:revisionId/tables/:tableId/rows/:rowId/count-foreign-keys-by', () => {
      it('owner can get foreign keys by count', async () => {
        const result = await request(app.getHttpServer())
          .get(
            `/api/revision/${preparedData.project.draftRevisionId}/tables/${preparedData.project.tableId}/rows/${preparedData.project.rowId}/count-foreign-keys-by`,
          )
          .set('Authorization', `Bearer ${preparedData.owner.token}`)
          .expect(200)
          .then((res) => res.text);
    ...
    describe('GET /revision/:revisionId/tables/:tableId/rows/:rowId/count-foreign-keys-to', () => {
      it('owner can get foreign keys to count', async () => {
        const result = await request(app.getHttpServer())
          .get(
            `/api/revision/${preparedData.project.draftRevisionId}/tables/${preparedData.project.tableId}/rows/${preparedData.project.rowId}/count-foreign-keys-to`,
          )
          .set('Authorization', `Bearer ${preparedData.owner.token}`)
          .expect(200)
          .then((res) => res.text);
  ...
  describe('Write Operations - Error Cases', () => {
    ...
    describe('PUT /revision/:revisionId/tables/:tableId/rows/:rowId', () => {
      ...
      it('should return error for non-existent row', async () => {
        return request(app.getHttpServer())
          .put(
            `/api/revision/${preparedData.project.draftRevisionId}/tables/${preparedData.project.tableId}/rows/non-existent-row`,
          )
          .set('Authorization', `Bearer ${preparedData.owner.token}`)
          .send({
            data: {
