...
const initializeSession = async (app: INestApplication): Promise<string> => {
  ...
  describe('Authentication Operations', () => {
    ...
    describe('login and me tools', () => {
      ...
      it('should return user info after login via me tool', async () => {
        const sessionId = await initializeSession(app);
        await loginSession(app, sessionId, fixture.owner.user.username);
      ...
      it('should login with access token', async () => {
        ...
        const meRes = await mcpPost(app, sessionId, {
          jsonrpc: '2.0',
          id: 3,
          method: 'tools/call',
          params: { name: 'me', arguments: {} },
